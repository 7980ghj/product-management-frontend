...
setImagePreview(product.productImage && product.productImage.startsWith('data:') ? product.productImage : `${BACKEND_URL}${product.productImage}`) }
    } catch (error) {
...
<img
  src={imagePreview}
  alt="Preview"
  className="w-44 h-44 object-cover rounded-2xl shadow-lg shadow-purple-500/10 border-2 border-white/50"
/>                </div>
              ) : (
                <div>
